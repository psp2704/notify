...
function EditInstallation() {
  ...
  return (
    <div className="min-h-screen  p-6">
      <h2 className="text-center text-4xl mb-4 font-bold text-navy">
        Registration Form
      </h2>
      <hr className="mb-5" />
      <form
        className="bg-white rounded-lg p-8 max-w-7xl mx-auto  "
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div className="mb-4">
            <label
              className="block text-navy text-sm font-bold mb-2"
